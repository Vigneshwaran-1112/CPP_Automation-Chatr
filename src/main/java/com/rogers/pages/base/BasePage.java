...
public class BasePage {
	 ...
	 */
	public static ReusableActions getReusableActionsInstance() {
	...
	/**
	 * Waiting for Spinner to be disappeared
	 *
	 * @author Vedachalam.Vasudevan
	 */
	/*
	 * public void waitforOverlayLoadingSpinnerToDisapper() { if
	 * (getReusableActionsInstance().isElementVisible(overlayLoadingspinner, 2)) {
	 * getReusableActionsInstance().waitForElementInvisibilityNOException(
	 * overlayLoadingspinner, 5); } }
	 */
